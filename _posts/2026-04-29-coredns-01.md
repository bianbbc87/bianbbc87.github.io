...
## musl에서도 search fallback을 지원하면 안 될까?

결론부터: **musl은 의도적으로 fallback을 거부한다. 앞으로도 안 바뀐다.**

관련 논의는 musl 메일링 리스트에 여러 번 올라왔고, 메인테이너 Rich Felker는 일관되게 거절했다. 대표 사례는 [2019년 Andrey Arapov의 문제 제기](https://www.openwall.com/lists/musl/2019/09/13/4).
